...
const MultipileChoice = require("./multipileChoiceAnswer.model")(); 

describe('multi answer model', function () {
    describe('unit tests', function () {
        it('should create an multi question', async function () {
            ...
            const multi = await new MultipileChoice({
                selectedChoice: "De goede", 
                createdBy: user._id, 
                answeredDate: new Date, 
                questionId: question._id, 
            })

            await expect(multi.save()).to.be.ok;
        });
        ...
        it('should reject a missing answer content', async function () {
            ...
            await expect(multi.save()).to.be.rejectedWith(Error);
        });
